                      ...
                      <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                          ...
                          <div class="media-body">
                            <div class="float-right"><a  href="/admin/allservice/adminNewCompany" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/adminNewCompany">新加坡公司注册</a></div>
                    ...
                    <div class="summary-item">
                      ...
                      <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                          ...
                          <div class="media-body">
                            <div class="float-right"><a  href="/admin/allservice/annualReview" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/annualReview">新加坡公司年审</a></div>
                        ...
                        <li class="media">
                          ...
                          <div class="media-body">
                             <div class="float-right"><a  href="/admin/allservice/accountingServices" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/accountingServices">新加坡会计服务</a></div>
                    ...
                    <div class="summary-item">
                      ...
                      <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                          ...
                          <div class="media-body">
                            <div class="float-right"><a  href="/admin/allservice/openAccount" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/openAccount">新加坡银行开户</a></div>
                        ...
                        <li class="media">
                          ...
                          <div class="media-body">
                             <div class="float-right"><a  href="/admin/allservice/openAccount" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/openAccount">离岸银行开户</a></div>
                        ...
                        <li class="media">
                          ...
                          <div class="media-body">
                             <div class="float-right"><a  href="/admin/allservice/licenseApplication" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/licenseApplication">新加坡商标与执照申请</a></div>
                        ...
                        <li class="media">
                          ...
                          <div class="media-body">
                             <div class="float-right"><a  href="/admin/allservice/GSTApplication" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/GSTApplication">新加坡消费税申请</a></div>
                    ...
                    <div class="summary-item">
                      ...
                      <ul class="list-unstyled list-unstyled-border">
                        ...
                        <li class="media">
                          ...
                          <div class="media-body">
                             <div class="float-right"><a  href="/admin/allservice/callService" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/callService">呼叫转移服务</a></div>
                        ...
                        <li class="media">
                          ...
                          <div class="media-body">
                             <div class="float-right"><a  href="/admin/allservice/officeService" class="btn btn-warning">在线注册</a></div>
                            <div class="media-title"><a href="/admin/allservice/officeService">新加坡共享办公室</a></div>
