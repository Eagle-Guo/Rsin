...
<html lang="zh-CN">
	...
	<body>
								...
								<div class="row">
									<div class="col-12 col-lg-8 ml-auto mr-auto mb-4">
										<div class="multisteps-form__progress">
											<button id="header_service" class="multisteps-form__progress-btn js-active" type="button" title="选择服务">选择服务</button>
											<button id="header_info" class="multisteps-form__progress-btn" type="button" title="信息填报">信息填报</button>
											<button id="header_signature" class="multisteps-form__progress-btn" type="button" title="电子签名" disabled onclick="top.location='/admin/onlineSignature'">电子签名</button>
											<button id="header_upload" class="multisteps-form__progress-btn" type="button" title="上传资料" disabled onclick="top.location='/admin/uploadPage'">上传资料</button>
										</div>
									</div> 
						                ...
						                <div class="card">
						                	<div class="card-body">
									          <div class="section-body">
									            ...
									            <p class="section-lead"> 请点击<a href="/admin/onlineSignature"> "此处" </a>完成 "在线签名" 步骤。</p> 
									          </div>
						                 	 </div>
						                </div>
						            </div>	
									...
									<div class="col-lg-8 col-md-12 col-12 col-sm-12 leftside">
										<form class="newCompany multisteps-form__form" action="/view/registerNewCompany" method="post" enctype="multipart/form-data" id="newcompanyForm">
											...
											<div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
												<input type="hidden" id="save_flag" value="false">
												...
												<div class="multisteps-form__content c_top">
													<div class="card-body">
														...
														<div class="button-row d-flex mt-4">
															...
															<button class="btn btn-primary saveBtn" type="button" title="save" onclick="saveToBackend()" disabled id="savecompany">保存所填信息</button>
											...
											<!-- 电子签名 -->
											<div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
												<h3 class="multisteps-form__title">电子签名</h3>
												<div class="multisteps-form__content c_top">
													<div class="card-body">
														<div class="section-title">请点击<a href="/admin/onlineSignature">这里进入签名页面</a></div>
													</div>
												</div>
												<div class="button-row d-flex mt-4">
													<button class="btn btn-primary js-btn-prev" type="button" title="Prev">上一步</button>
													<button class="btn btn-primary ml-auto js-btn-next" type="button" title="Next" onclick="showServiceTable()" id="step3next">下一步</button>
												</div>
											</div>
											
											<!-- 上传资料 -->
											<div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
												<h3 class="multisteps-form__title">上传资料</h3>
												<div class="multisteps-form__content c_top">
													<div class="card-body">
														<div class="section-title">请点击<a href="/admin/uploadPage">这里进入上传资料页面</a></div>
													</div>
												</div>
												<div class="button-row d-flex mt-4">
													<button class="btn btn-primary js-btn-prev" type="button" title="Prev">上一步</button>
	    ...
	    <script src="../../../../assets/js/admin/adminNewCompany.js"></script>
