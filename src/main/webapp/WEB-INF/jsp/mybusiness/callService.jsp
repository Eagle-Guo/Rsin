							...
							<div class="multisteps-form">
								...
								<div class="row">
									...
									<div class="col-lg-8 col-md-12 col-12 col-sm-12 leftside">
										<form style="overflow: unset;" class="multisteps-form__form" action="/view/registerNewCompany" method="post" enctype="multipart/form-data" id="newcompanyForm">
																	...
																	<li class="list-group-item d-flex justify-content-between align-items-center choosedsvr" onclick="choosedsv(0)">
																		...
																		<div class="form-group" style="margin-bottom: 0px;">
																			<div class="input-group">
																				<select class="custom-select" id="countglotel" onchange="runglotel(1)" >
