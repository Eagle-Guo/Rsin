                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">通告题目</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">通告类型</label>
                      <div class="col-sm-12 col-md-7">
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">内容区域</label>
                      <div class="col-sm-12 col-md-7">
                        <textarea class="summernote-simple"  style="width:100%;"></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">附件</label>
                      <div class="col-sm-12 col-md-7">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <button class="btn btn-primary">创建通告</button>
                      </div>
                    </div>
                  </div>
                </div>
