						 ...
						 <div class="row text_no_di2">
 						 ...
 						 <div class="row text_no_di2">
							...
							<div class="col-md-10 col-sm-10"> 
								<p class="text_signfile">
								<span>
									(vii)the identification number or registration number on the corporate entity register of the jurisdiction where the person is formed or incorporated, if applicable:<span class="text_cn">
              ...
              <div class="card priDesc view"  id="b1" >
                ...
                <div class="card-body fixcardhieht">
                     ...
                     <div class="media-content">
                    	 ...
                    	 <p class="text_signfile text_centre text_cn">XX私人有限公司</p>         
