      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">您好， 小燕</div></a>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a class="nav-link" href="index-0.html">年审</a></li>
                  <li><a class="nav-link" href="index.html">付款状态</a></li>
                  <li><a class="nav-link" href="index.html">新功能上线</a></li>
                </ul>
              </li>
              ...
              <li><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>一键式服务平台</span></a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link beep beep-sidebar" href="components-avatar.html">银行开户</a></li>
                  <li><a class="nav-link" href="components-chat-box.html">其它选择业务记录</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="far fa-file-alt"></i> <span>我的付款</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="forms-advanced-form.html">已完成记录</a></li>
                  <li><a class="nav-link" href="forms-editor.html">已付款，进行中业务</a></li>
                  <li><a class="nav-link" href="forms-validation.html">已提交末付款业务</a></li>
                  <li><a class="nav-link" href="bootstrap-tooltip.html">关闭业务</a></li>
                  <li><a class="nav-link" href="bootstrap-typography.html">其它付款</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-map-marker-alt"></i> <span>我的帐号</span></a>
                <ul class="dropdown-menu">
                  <li><a href="gmaps-advanced-route.html">个人帐户信息</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-plug"></i> <span>帮助中心</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="modules-calendar.html">支持文档查询</a></li>
                  <li><a class="nav-link" href="modules-chartjs.html">客服联系方式</a></li>
                  <li><a class="nav-link" href="modules-datatables.html">在线咨询或邮件咨询</a></li>
                </ul>
              </li>
            </ul>
