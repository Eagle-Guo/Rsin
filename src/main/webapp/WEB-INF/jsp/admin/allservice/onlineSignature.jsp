								...
								<div class="row">
									<div class="col-12 col-lg-8 ml-auto mr-auto mb-4">
										<div class="multisteps-form__progress">
											<button class="multisteps-form__progress-btn js-active " disabled type="button" title="选择服务">选择服务</button>
											<button class="multisteps-form__progress-btn js-active " disabled type="button" title="信息填报">信息填报</button>
											<button class="multisteps-form__progress-btn js-active" type="button" title="电子签名" >电子签名</button>
											<button class="multisteps-form__progress-btn" type="button" title="上传资料"  onclick="top.location='/admin/uploadPage'">上传资料</button>
